...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth, page=1]{img/visualization.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth, page=5]{img/visualization.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth, page=6]{img/visualization.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth, page=7]{img/visualization.pdf}
