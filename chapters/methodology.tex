...
To evaluate the effectiveness of the \ac{dea}, its performance is compared to baseline strategies such as \textbf{Random guessing}, in which candidate plaintext values are assigned randomly to encodings.

This baseline represents a naïve yet plausible strategies in the absence of supervised learning.
