...
%DeppL
\ac{bf} Encoding, based on Bloom filters, is the most widely used and is considered the reference standard. 
...
Further research also exists to improve \ac{bf} by adding a diffusion layer to it.  % Cite Armknecht
